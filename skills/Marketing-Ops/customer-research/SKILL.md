...
> Adapted from [customer-research](https://github.com/coreyhaines31/marketingskills/tree/main/skills/customer-research) by Corey Haines (MIT). Same method, with this library's rule that company context is scanned, listed, and confirmed before it's read.
