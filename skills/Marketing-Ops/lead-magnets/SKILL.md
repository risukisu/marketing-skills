---
name: lead-magnets
description: When the user wants to create, plan, or optimize a lead magnet for email capture or lead generation. Also use when the user mentions "lead magnet," "gated content," "content upgrade," "downloadable," "ebook," "cheat sheet," "checklist," "template download," "opt-in," "freebie," "PDF download," "resource library," "content offer," "email capture content," "Notion template," "spreadsheet template," or "what should I give away for emails." Use this for planning what to create and how to distribute it. For the capture page itself, see cro.
metadata:
  source: https://github.com/coreyhaines31/marketingskills/tree/main/skills/lead-magnets (v2.0.0, MIT, Corey Haines)
...
> Adapted from [lead-magnets](https://github.com/coreyhaines31/marketingskills/tree/main/skills/lead-magnets) by Corey Haines (MIT). Same method, with this library's rule that company context is scanned, listed, and confirmed before it's read.
...
In this library:
- **content-strategy**: the gated content upgrade slot in the quarterly hub is a lead magnet
- **cro**: optimizing the capture page and form
- **customer-research**: finding the specific problem worth solving
- **linkedin-ads**: paid promotion of a lead magnet to a B2B audience
- **writing-assistant** / **copy-deslop**: writing the lead magnet itself
- **seo-content-brief**: when the lead magnet grows out of a ranking article

Not in this library (upstream has them): free-tools, emails, popups, analytics, social.
